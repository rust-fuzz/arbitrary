...
///
/// <div class="warning">This method is deprecated. Users should instead implement <a href="../trait.Arbitrary.html#method.faillible_size_hint"><code>faillible_size_hint</code></a> and use <a href="fn.faillible_recursion_guard.html"><code>faillible_recursion_guard</code></a></div>
#[inline]
#[deprecated(note = "use `faillible_recursion_guard` instead")]
...
///
/// This should be used when implementing [`faillible_size_hint`](crate::Arbitrary::faillible_size_hint)
#[inline]
pub fn faillible_recursion_guard(
    depth: usize,
